...
% SUB_TURBINE_LCH4  Turbine 1 — drives the LCH4 pump shaft.
% Working fluid : methane (gaseous, post cooling channels)
% Expansion     : p_in -> p_turbine_LCH4_out (= p_mid from cyclesolver)
...
W_available = inputs.m_dot_fuel * (h_in - h_out);  % [W]  BUG FIX: was W_turbine_LCH4
...
u_blade   = pi * inputs.D_mean_LCH4 * inputs.N_shaft_LCH4 / 60;
nu_single = u_blade / C0_full;
nu_target = inputs.nu_target_LCH4; 
...
h_blade = A_flow / (pi * inputs.D_mean_LCH4);
D_tip   = inputs.D_mean_LCH4 + h_blade;
D_hub   = inputs.D_mean_LCH4 - h_blade;
HTR     = D_hub / D_tip;
...
% ================================================================
% 6. FEASIBILITY  BUG FIX: was W_turbine_LCH4 (undefined), removed warning(...) placeholders
% ================================================================
...
key_values.D_mean      = inputs.D_mean_LCH4;
